            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <div  style={style.nav}>
                <Nav className="nav">
                  ...
                  <Nav.Link href ="/blog" style={style.navItem}>Blog</Nav.Link>
                  <Nav.Link href ="/price" style={style.navItem}>Pricing</Nav.Link>
                  <Nav.Link href ="/contact" style={style.navItem}>Contact Us</Nav.Link>
                </Nav>
              </div>
            </Navbar.Collapse>
          </div>
